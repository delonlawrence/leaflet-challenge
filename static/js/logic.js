...
//setting up global variables
    ...
    // Set the parameters that will determine the color of each circle marker
...
function createMap(earthquakes){
    ...
    // Overlay view list for the control function
        let baseMaps = {
            "Street View": street,
...
function createFeatures(earthquakeData) {
    ...
    // Create circle markers that will have a radius based on the magnitude (circles magnified by 3 for better visuals) and color based on the depth
